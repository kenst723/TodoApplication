...
class TaskAdapter02(
    ...
    private var taskList: OrderedRealmCollection<Task02>,
    autoUpdate: Boolean
) :
    RealmRecyclerViewAdapter<Task02, TaskAdapter02.ViewHolder>(taskList, autoUpdate) {
    private val realm: Realm by lazy { Realm.getDefaultInstance() }

    private val getDateFunc = GetDateFunc()
    private val realmFunc = RealmFunc02()
    ...
    interface OnItemClickListener {
        fun onItemClick(item: Task02, position: Int, text: String)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        val task: Task02 = taskList[position] ?: return
